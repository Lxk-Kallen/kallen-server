...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://81.68.188.195:3306/kallen?useUnicode=true&useSSL=false&characterEncoding=utf8");
